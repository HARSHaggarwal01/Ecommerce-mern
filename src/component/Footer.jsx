...
const Footer = () => {
  return (
    <>
            ...
            <div className="footer-widget">
                ...
                <div className="row footer-widget-wrapper pt-100 pb-40">
                    ...
                    <div className="footer-widget-box about-us">
                        ...
                        <li>
                            <a href="https://live.themewild.com/cdn-cgi/l/email-protection#eb82858d84ab8e938a869b878ec5888486">
            ...
            <div className="copyright">
                ...
                <div className="copyright-wrap">
                    ...
                    <div className="col-12 col-lg-6 align-self-center">
                        ...
                        © Copyright <span id="date" /> <a href="index-2.html"> Medion </a>{" "}
                        All Rights Reserved.
                        </p>
                    </div>
                    <div className="col-12 col-lg-6 align-self-center">
        ...
        <a href="#" id="scroll-top"><i className="fas fa-arrow-up-from-arc"></i></a>
    </>
